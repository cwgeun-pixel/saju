// 원본 @orrery/core 계산 모듈을 브라우저에서 사용하기 위한 추출 파일
import {
  adjustKdtToKst
...
// ../../node_modules/.bun/lunar-javascript@1.7.7/node_modules/lunar-javascript/lunar.js
var require_lunar = __commonJS({
  "../../node_modules/.bun/lunar-javascript@1.7.7/node_modules/lunar-javascript/lunar.js"(exports, module) {
    "use strict";
    (function(root, factory) {
      ...
      var EightChar = /* @__PURE__ */ (function() {
        var _fromLunar = function(lunar) {
          return {
            ...
            _getDiShi: function(zhiIndex2) {
              var offset = LunarUtil.CHANG_SHENG_OFFSET[this.getDayGan()];
              var index = offset + (this.getDayGanIndex() % 2 === 0 ? zhiIndex2 : -zhiIndex2);
              if (index >= 12) {
                index -= 12;
              }
              if (index < 0) {
            ...
            getTaiYuan: function() {
              var ganIndex2 = this._p.lunar.getMonthGanIndexExact() + 1;
              if (ganIndex2 >= 10) {
                ganIndex2 -= 10;
              }
              var zhiIndex2 = this._p.lunar.getMonthZhiIndexExact() + 3;
              if (zhiIndex2 >= 12) {
                zhiIndex2 -= 12;
              }
              return LunarUtil.GAN[ganIndex2 + 1] + LunarUtil.ZHI[zhiIndex2 + 1];
            },
            ...
            getTaiXi: function() {
              ...
              var ganIndex2 = 2 === this._p.sect ? lunar2.getDayGanIndexExact2() : lunar2.getDayGanIndexExact();
              var zhiIndex2 = 2 === this._p.sect ? lunar2.getDayZhiIndexExact2() : lunar2.getDayZhiIndexExact();
              return LunarUtil.HE_GAN_5[ganIndex2] + LunarUtil.HE_ZHI_6[zhiIndex2];
            },
            ...
            getMingGong: function() {
              ...
              var ganIndex2 = (this._p.lunar.getYearGanIndexExact() + 1) * 2 + offset;
              while (ganIndex2 > 10) {
                ganIndex2 -= 10;
              }
              return LunarUtil.GAN[ganIndex2] + LunarUtil.MONTH_ZHI[offset];
            },
      ...
      var LunarTime = /* @__PURE__ */ (function() {
        var _fromYmdHms = function(lunarYear, lunarMonth, lunarDay, hour, minute, second) {
          ...
          var zhiIndex2 = LunarUtil.getTimeZhiIndex([(hour < 10 ? "0" : "") + hour, (minute < 10 ? "0" : "") + minute].join(":"));
          var ganIndex2 = (lunar.getDayGanIndexExact() % 5 * 2 + zhiIndex2) % 10;
          return {
            _p: {
              ganIndex: ganIndex2,
              zhiIndex: zhiIndex2,
...
// ../../node_modules/.bun/lunar-javascript@1.7.7/node_modules/lunar-javascript/index.js
var require_lunar_javascript = __commonJS({
  "../../node_modules/.bun/lunar-javascript@1.7.7/node_modules/lunar-javascript/index.js"(exports, module) {
    "use strict";
...
function zhiAt(index) {
  return DI_ZHI[(index % 12 + 12) % 12];
}
function ganAt(index) {
...
function getPalaceGan(yearGan, zhi) {
...
function getWuXingJu(palaceGan, palaceZhi) {
...
function calculateZiweiPosition(lunarDay, juNumber) {
...
function calculateTianfuPosition(ziweiZhi) {
...
function placeMainStars(ziweiZhi, tianfuZhi) {
  const result = {};
  const ziweiIdx = zhiIndex(ziweiZhi);
...
function placeAuxStars(yearGan, yearZhi, lunarMonth, hour) {
  const result = {};
  const hourIdx = hourZhiIndex(hour);
...
function calculateLiunian(chart, year) {
...
function getDaxianList(chart) {
  const startAge = chart.daXianStartAge;
  const mingIdx = zhiIndex(chart.mingGongZhi);
  const isYangGan = ganIndex(chart.yearGan) % 2 === 0;
  const direction = isYangGan && chart.isMale || !isYangGan && !chart.isMale ? 1 : -1;
  const result = [];
  const mainStarNames = /* @__PURE__ */ new Set([
    "\u7D2B\u5FAE",
    "\u5929\u6A5F",
    "\u592A\u967D",
    "\u6B66\u66F2",
  ...
  for (let i = 0; i < 12; i++) {
    ...
    const palace = getPalaceByZhi(chart, palaceZhi);
    if (palace) {
      const mainStars = palace.stars.filter((s) => mainStarNames.has(s.name)).map((s) => s.name);
      result.push({
        ageStart,
        ageEnd,
